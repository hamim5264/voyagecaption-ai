...
app = FastAPI(title="VoyageCaption AI Backend", version="1.1.0")
...
async def generate_caption(
    ...
    Multipart form-data:
      - images: multiple files
      - platform, tone, context, userTitle, userDescription
    """
    ...
    # 1️⃣ Classify travel probability per image
    travel_probs = travel_clf.predict_proba(pil_images)
    ...
    # ✅ IMPORTANT FIX: expose debug to API response
    result["debug"] = debug
